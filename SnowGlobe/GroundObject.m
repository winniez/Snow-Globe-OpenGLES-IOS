...
// Models
#import "ManorGroundOBJ.h"
#import "ManorGroundMTL.h"
...
-(id) loadObject
{
    ...
    textureFiles = [NSArray arrayWithObjects:@"Tree1.jpg",
                    @"RustyFence1.jpg",
                    @"Stone1.jpg",
                    @"ManorGround1.jpg", nil];
    ...
    /*
     ...
     NSLog(@"num of normals %d",  (int)(sizeof(ManorGroundOBJNormals)/sizeof(float)/3));
     NSLog(@"num of tex coords %d",  (int)(sizeof(ManorGroundOBJTexCoords)/sizeof(float)/2));
    */
    return self;
}
             ...
             NMatrix :(GLKMatrix3) normalMatrix
{
    ...
    // Load OBJ Data
    glVertexAttribPointer(_attributes.aVertex, 3, GL_FLOAT, GL_FALSE, 0, ManorGroundOBJVerts);
    glVertexAttribPointer(_attributes.aNormal, 3, GL_FLOAT, GL_FALSE, 0, ManorGroundOBJNormals);
    glVertexAttribPointer(_attributes.aTexture, 2, GL_FLOAT, GL_FALSE, 0, ManorGroundOBJTexCoords);
    
    // Load MTL Data
    for(int i=1; i<ManorGroundMTLNumMaterials; i++)
    {
        ...
        glDrawArrays(GL_TRIANGLES, ManorGroundMTLFirst[i], ManorGroundMTLCount[i]);
        glDisable(GL_BLEND);
